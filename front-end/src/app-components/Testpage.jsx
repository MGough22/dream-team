...
export default function Testpage() {
  return (
    ...
    <ThemeProvider theme={theme}>
      ...
      <Button>
        <Text color="red">
          A Button for our Dream Interpeter App using only Chakra UI components
          Chakra CSS styling conventions.
        </Text>
      </Button>
      <Box css={customStyle}>
        A Box for our Dream Interpreter App using Chakra UI components and
...
`}
      ...
      <MyCustomButton>
        A custom reusable button styled with Emotion
      </MyCustomButton>
    </ThemeProvider>
  );
}
